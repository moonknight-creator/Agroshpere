...
<html lang="en">
	<head>
		<!-- Meta -->
		<meta name="google-site-verification" content="sd4P_aRk_53SmQec_1-VG0hZZU1JDAMeZgHmLWYQFmE" />
		<meta charset="utf-8">
	    ...
	    <title>AGRO AVATAR Home Page</title>
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/3.png);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
		...
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/4.png);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->

	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/5.png);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#books" data-toggle="tab">Horticulture</a></li>
					<li><a href="#furniture" data-toggle="tab">Crops</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
